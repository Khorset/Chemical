...
&НаСервереБезКонтекста
Процедура ПерезаполнитьНоменклатуруПартнераВЗаписи(Запись, Партнер, ЭтоНоваяЗапись)
	...
	ИнтеграцияСМаркетплейсамиСервер.СоздатьОбновитьНоменклатуруПартнера(Партнер, ДанныеНоменклатуры);
