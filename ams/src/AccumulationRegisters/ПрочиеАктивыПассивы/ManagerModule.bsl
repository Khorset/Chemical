...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заменяет статью ""Доходы текущего периода"" на ""Прибыли и убытки"" в движениях регистра ""Активы и пассивы"" незаблокированных периодов.'");
