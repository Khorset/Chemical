...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// адаптация под 8.5 ++
	Попытка Элементы.ПраваПометка.ВидФлажка = ВидФлажка.Флажок; Исключение КонецПопытки;
	// адаптация под 8.5 --
...
Процедура ДобавитьПрава()
	...
	// "Поиск документов по ШК"
	
	СтруктураПоиска.ДляТСД = "is_allow_scan_doc_barcode";	
	МассивСтрок = ТЧПрава.НайтиСтроки(СтруктураПоиска);
	
	Если МассивСтрок.Количество() = 0 Тогда 
	
		СтрТЧ = ТЧПрава.Добавить();
		СтрТЧ.Право = "Поиск документов по ШК";
		СтрТЧ.ДляТСД = "is_allow_scan_doc_barcode";
		СтрТЧ.Пометка = Истина; 
		ЭтаФорма.Модифицированность = Истина;
	...
	// "Отмена/очистка строк в документе"
	
	СтруктураПоиска.ДляТСД = "is_allow_cancel_doc_details";	
	МассивСтрок = ТЧПрава.НайтиСтроки(СтруктураПоиска);
	
	Если МассивСтрок.Количество() = 0 Тогда 
	
		СтрТЧ = ТЧПрава.Добавить();
		СтрТЧ.Право = "Отмена/очистка строк в документе";
		СтрТЧ.ДляТСД = "is_allow_cancel_doc_details";
		СтрТЧ.Пометка = Истина;
		ЭтаФорма.Модифицированность = Истина;
	...
	СтруктураПоиска.ДляТСД = "is_allow_feature_books";	
	МассивСтрок = ТЧПрава.НайтиСтроки(СтруктураПоиска);
	
	Если МассивСтрок.Количество() = 0 Тогда 
	
		СтрТЧ = ТЧПрава.Добавить();
		СтрТЧ.Право = "Справочники";
		СтрТЧ.ДляТСД = "is_allow_feature_books";
		СтрТЧ.Пометка = Истина;
		ЭтаФорма.Модифицированность = Истина;
	...
	СтруктураПоиска.ДляТСД = "is_allow_feature_operations";	
	МассивСтрок = ТЧПрава.НайтиСтроки(СтруктураПоиска);
	
	Если МассивСтрок.Количество() = 0 Тогда 
	
		СтрТЧ = ТЧПрава.Добавить();
		СтрТЧ.Право = "Операции";
		СтрТЧ.ДляТСД = "is_allow_feature_operations";
		СтрТЧ.Пометка = Истина;
		ЭтаФорма.Модифицированность = Истина;
	...
	СтруктураПоиска.ДляТСД = "is_allow_feature_dashboard";	
	МассивСтрок = ТЧПрава.НайтиСтроки(СтруктураПоиска);
	...
	Если МассивСтрок.Количество() = 0 Тогда 
		...
		СтрТЧ = ТЧПрава.Добавить();
		СтрТЧ.Право = "Дашборд";
		СтрТЧ.ДляТСД = "is_allow_feature_dashboard";
		СтрТЧ.Пометка = Истина;
		ЭтаФорма.Модифицированность = Истина;
