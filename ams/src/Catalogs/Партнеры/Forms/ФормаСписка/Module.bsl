...
&НаКлиенте
Процедура Подключаемый_амсПриИзменении_СкрытьЗакрытые()
	//@skip-check module-self-reference
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор, "Закрыт", Ложь, ВидСравненияКомпоновкиДанных.Равно,, ЭтотОбъект._СкрытьЗакрытые);
КонецПроцедуры
