...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	мср.ПередЗаписьюНаСервереДоговорыКонтрагентов(ТекущийОбъект, Отказ); 
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~1-7
...
Процедура СтатусПриИзменении(Элемент)
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~2
	AMS_Клиент.ПриИзмененииРеквизитаДоговорыКонтрагентов(Объект, Элемент.Имя);
КонецПроцедуры
...
&НаКлиенте
Процедура Подключаемый_амсПриИзменении_Номер(Элемент)
	AMS_Клиент.ПриИзмененииРеквизитаДоговорыКонтрагентов(Объект,Элемент.Имя);
КонецПроцедуры
&НаКлиенте
Процедура Подключаемый_амсПриИзменении_Дата(Элемент)
	AMS_Клиент.ПриИзмененииРеквизитаДоговорыКонтрагентов(Объект,Элемент.Имя);
КонецПроцедуры
