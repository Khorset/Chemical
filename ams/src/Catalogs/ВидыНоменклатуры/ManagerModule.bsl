...
Функция ПодготовитьДеревоОперандов(НаборыСвойств, ИмяШаблона) Экспорт
	...
	ОграниченияРазвертки.НеВыводимыеРеквизиты = "ВерсияДанных,УдалитьПодакцизныйТовар";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Версия = "11.5.26.12";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("52a54baa-0905-4d32-a14a-f7523ead169d");
	...
	Пока Справочник.Следующий() Цикл
		...
		Попытка
			...
			Если СправочникОбъект <> Неопределено Тогда
				...
				НайденныеСтроки = СправочникОбъект.РеквизитыДляКонтроляНоменклатуры.НайтиСтроки(Новый Структура("ИмяРеквизита", "УдалитьПодакцизныйТовар"));
				Если НайденныеСтроки.Количество() > 0 Тогда
