...
Процедура ПриЗаписи(Отказ)
	...
	Попытка ОбъектОбработки.ИмяОбъекта = ОбъектОбработки.Наименование; Исключение КонецПопытки; 
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	РазрешеноСозданиеНаТСД 					= Истина;
	РежимСозданияДокументов 				= 1;	
	ОбновлятьТоварыСДокументом 				= Истина;
	РазрешитьВыгрузкуНеполногоДокумента 	= 1;
	ПриСканированииНовогоТовара 			= 1;
	ШтрихкодыТолькоПоШаблонам 				= Истина;
	ПервичныйПоискПоШКвЗадании 				= Истина;
	ВсеШтрихкодыТовара                      = Истина;
	ЗагружатьКомментарий                 	= 0;
	АвтоматическийКомментарийИспользовать 	= Истина;
	АвтоматическийКомментарий 				= "Выполнено в DataMobile";
	ИспользоватьПодбор 						= Истина;
	ТабличнуюЧастьПриЗагрузкеПодбор 		= 3;
	ПриСканированииТовараПодбор         	= 2;
	ПриПревышенииЗаданияПодбор          	= 1;
	РучнойВводКоличестваПодбор          	= Истина;
	ПодтверждатьЭнтеромПодбор           	= Истина;
	РучнойВводШК                            = Истина;
