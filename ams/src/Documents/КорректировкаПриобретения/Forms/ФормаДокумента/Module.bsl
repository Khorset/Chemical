...
Функция ПараметрыРегистрацииУведомленийОВвозеПрослеживаемыхТоваровСервер(Знач Объект)
	...
	Возврат Документы.КорректировкаПриобретения.ПараметрыРегистрацииУведомленийОВвозеПрослеживаемыхТоваров(Объект);
...
Процедура ОбновитьТекстДокументыНаОсновании()
	...
	ПараметрыРегистрацииУведомленийОВвозе = Документы.КорректировкаПриобретения.ПараметрыРегистрацииУведомленийОВвозеПрослеживаемыхТоваров(Объект);
