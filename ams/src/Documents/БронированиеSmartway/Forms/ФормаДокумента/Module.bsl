...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Иначе
		...
		ИначеЕсли Объект.ДатаНачала < НачалоДня(Объект.Дата) Тогда
			ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Дата начала не может быть раньше даты документа бронирования.'"), Объект.Ссылка, "Объект.ДатаНачала",,Отказ);
