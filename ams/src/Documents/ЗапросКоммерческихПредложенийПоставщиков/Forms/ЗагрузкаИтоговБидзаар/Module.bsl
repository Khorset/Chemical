...
Процедура ФормированиеКоммерческихПредложенийЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	// Перенесем информацию из созданных коммерческих предложений в документ "Запрос коммерческих предложений"
	Элементы.НазваниеТекущейДлительнойОперации.Заголовок = НСтр(
...
Процедура УстановитьИспользованиеХарактеристик()
	...
	МодульТорговыеПредложенияСлужебный = ОбщегоНазначения.ОбщийМодуль("ТорговыеПредложенияСлужебный");
	МодульТорговыеПредложенияСлужебный.ЗаполнитьСведенияОНоменклатуре(Товары, "ЕдиницаИзмерения, ЕдиницаИзмерения");
