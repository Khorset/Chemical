...
&НаКлиенте
Процедура Подключаемый_AMS_Команда_ПечатьТН_Из_ПередачаТоваровХранителю(Команда)
	Массив = Новый Массив;
	...
	УправлениеПечатьюКлиент.ВыполнитьКомандуПечати("Обработка.AMS_Продажи","ТН",Массив,Неопределено,Парам);
КонецПроцедуры

&НаСервере
Процедура AMS_УправлениеРеквизитамиДоставки()
	AMS_СобытияФорм.УправлениеРеквизитамиДоставкиAMS(ЭтотОбъект, "ПередачаТоваровХранителю");
КонецПроцедуры
