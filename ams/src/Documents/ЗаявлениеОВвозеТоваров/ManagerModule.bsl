...
Процедура ЗарегистрироватьУчетныеМеханизмы(МеханизмыДокумента) Экспорт
	...
	МеханизмыДокумента.Добавить("ПодакцизныеТовары");
...
Функция ТаблицаОстатковТоваровКОформлениюЗаявленийОВвозеТоваров(ДокументПоступления, ЗаполнениеНаОсновании = Ложь, ПериодОформления = Неопределено) Экспорт
	...
	Запрос.Текст = ТекстЗапросаТоварыКОформлениюЗаявленийОВвозе(, ИспользоватьПодакцизныеТовары);
...
Функция ТекстЗапросаТоварыКОформлениюЗаявленийОВвозе(ЗаполнениеНаОсновании = Ложь, ИспользоватьПодакцизныеТовары = Ложь)
	...
	ТекстЧастиЗапроса =
		УчетПодакцизныхТоваров.ТекстЗапросаДанныеПодакцизныхТоваров(ИспользоватьПодакцизныеТовары, "ТоварыКОформлению");
	ЧастиТекстаЗапроса.Добавить(ТекстЧастиЗапроса);
	...
	|		 * ТоварыКОформлению.Количество 			КАК НалоговаяБазаАкцизы,
	...
	|		 * ТоварыКОформлению.Количество				КАК СуммаАкциза,
	...
	|		ПО ТоварыКОформлению.Номенклатура = ПодакцизныеТовары.Номенклатура
	|ГДЕ
