...
Процедура КонтрагентПриИзмененииСервер()
	...
	РозничныеПродажиЛокализация.ПриИзмененииЭлемента(ЭтотОбъект, "Контрагент",);
...
Процедура ОбработкаВыбораПодборПоРеализацииСервер(ВыбранноеЗначение)
	...
	Для каждого СтрокаТовара Из ТаблицаТоваров Цикл
		...
		Если Не ЗначениеЗаполнено(СтрокаТовара.Склад)
...
Процедура ПроверитьНаличиеСкидокОплатБонуснымиБалламиЛокализация()
	...
	РезультатПроверки = РозничныеПродажиЛокализация.ПроверитьНаличиеСкидокОплатБонуснымиБаллами(ЭтотОбъект, "ЗаменяющиеТовары", Истина, Истина);
...
Процедура AMS_УправлениеРеквизитамиДоставки()
	AMS_СобытияФорм.УправлениеРеквизитамиДоставкиAMS(ЭтотОбъект, "ЗаявкаНаВозвратТоваровОтКлиента");
КонецПроцедуры
