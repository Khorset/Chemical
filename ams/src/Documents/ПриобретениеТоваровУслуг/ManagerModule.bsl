...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = '- заполняет реквизит ""Вариант приемки услуг"" значением из договора.'"));
...
Процедура ПроверитьТипыНоменклатуры(Организация, Договор, СписокНоменклатуры, Отказ) Экспорт
...
Функция ПолучитьРезультатЗапросаПоОстаткамЗаказов(ДанныеОтбора, СкладПоступления = Неопределено,
	...
	Иначе
		ВариантОформленияДокументовПоступленияПоУслугам = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДанныеОтбора.Договор,
			"ВариантОформленияДокументовПоступленияПоУслугам");
