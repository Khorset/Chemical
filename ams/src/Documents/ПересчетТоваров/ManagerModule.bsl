...
Процедура ОтразитьРаспределениеЗапасовДвижения(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстТоварныеМестаВНоменклатуре =
		...
		|	ТоварныеМестаОстатки.Склад КАК Склад,
		|	ТоварныеМестаОстатки.Дата КАК Дата,
		|	ТоварныеМестаОстатки.КонтролируемаяПартия КАК КонтролируемаяПартия,
		|	ТоварныеМестаОстатки.ДатаПодтвержденияКачества КАК ДатаПодтвержденияКачества,
		|	ТоварныеМестаОстатки.ПодлежитРазблокировке КАК ПодлежитРазблокировке,
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	мср.ДобавитьКомандыПечати(КомандыПечати, "СличительнаяВедомость");
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~1-7
...
Функция ПечатьЗадания(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	Пока ВыборкаПоДокументам.Следующий() Цикл
		...
		Пока ВыборкаПоСтрокамТЧ.Следующий() Цикл
			...
			//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~3
			Номенклатура = ВыборкаПоСтрокамТЧ.Номенклатура;
			Если AMS_ВызовСервера.ЭтоПродукцияAMS(Номенклатура) Тогда
				...
				//@skip-check bsl-legacy-check-string-literal
				ОбластьСтрокаТаблицыУпаковки.Параметры.ЕдиницаИзмеренияПредставлениеНоменклатура = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Упаковка, "Наименование");
			КонецЕсли;
			//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4
