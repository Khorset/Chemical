...
Процедура Подключаемый_AMS_Команда_ЗаполнитьОстатки(Команда)
	амсЗаполнитьОстатки(амсПолучитьОстатки());
КонецПроцедуры
&НаКлиенте
Процедура амсЗаполнитьОстатки(Таб)
	Объект.Товары.Очистить();
...
КонецПроцедуры
&НаСервере
Функция амсПолучитьОстатки()
	ВидыНоменклатуры = Новый Массив();
	ВидыНоменклатуры.Добавить(AMS_ВызовСервера.ВидНоменклатурыПродукцияЦеха1());
	ВидыНоменклатуры.Добавить(AMS_ВызовСервера.ВидНоменклатурыПродукцияЦеха2());
	ВидыНоменклатуры.Добавить(AMS_ВызовСервера.ВидНоменклатурыПродукцияЦеха3());
	ВидыНоменклатуры.Добавить(AMS_ВызовСервера.ВидНоменклатурыПродукцияНаборы());
