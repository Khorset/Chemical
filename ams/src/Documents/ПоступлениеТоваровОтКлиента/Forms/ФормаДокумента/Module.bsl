...
Процедура ОбновитьЗависимыеРеквизитыФормыСерверПоЗаказу()
	...
	Если Объект.Товары.Количество() = 0 Тогда
		...
		Элементы.КартинкаРасхождениеЗаказ.Подсказка = Неопределено;
		Элементы.КартинкаРасхождениеЗаказы.Подсказка = Неопределено;
...
Процедура ОбновитьЗависимыеРеквизитыФормыПоЗаказу(ЭлементыФормы, Товары, НадписьРасхождениеЗаказ)
	...
	Если КоличествоРасхождений > 0 Тогда
		...
		ЭлементыФормы.КартинкаРасхождениеЗаказ.Подсказка = НСтр("ru='Количество строк, не привязанных к распоряжению'");
		ЭлементыФормы.КартинкаРасхождениеЗаказы.Подсказка = НСтр("ru='Количество строк, не привязанных к распоряжениям'");
	Иначе
		НадписьРасхождениеЗаказ = "";
		...
		ЭлементыФормы.КартинкаРасхождениеЗаказ.Подсказка = Неопределено;
		ЭлементыФормы.КартинкаРасхождениеЗаказы.Подсказка = Неопределено;
	КонецЕсли;
