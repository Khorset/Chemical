...
Процедура УстановитьУсловноеОформление()
	...
	// Для ТЧ Расхождения
	ТипыНоменклатурыСАналитикойПодразделение = ПродажиСервер.ТипыНоменклатурыСАналитикойПодразделение();
	...
	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Объект.Расхождения.Подразделение");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.НеЗаполнено;
	
	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Объект.Расхождения.ТипНоменклатуры");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.ВСписке;
	ОтборЭлемента.ПравоеЗначение = ТипыНоменклатурыСАналитикойПодразделение;
	
	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("РеализацияЧерезКомиссионера");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.НеРавно;
	ОтборЭлемента.ПравоеЗначение = Истина;
	
	Элемент.Оформление.УстановитьЗначениеПараметра("ОтметкаНезаполненного", Истина);
	
	// отключение видимости подразделения, если НЕ Работа
	Элемент = УсловноеОформление.Элементы.Добавить();
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	// Проверяем галку [используются договоры контрагентов] в соглашении
	// на случай, если корректировку делаем на основании реализации с хозяйственной операцией Реализация клиенту
	Если ИспользоватьСоглашенияСКлиентами Тогда
		
		ИспользоватьОтгрузкуБезПереходаПраваСобственности2_5 =
			ПолучитьФункциональнуюОпцию("ИспользоватьОтгрузкуБезПереходаПраваСобственности2_5")
				И ОбщегоНазначенияУТ.ЗначениеРеквизитаОбъектаТипаБулево(Объект.Соглашение, 
...
Процедура ДоговорПриИзмененииСервер()
	...
	Если Объект.КорректировкаРеализации2_5 Тогда
		ОбновитьВариантыОтраженияРасхождений2_5();
		Элементы.РасхожденияВернуть.Видимость = ЗначениеЗаполнено(Объект.Договор);
	КонецЕсли;
...
Процедура УстановитьВидимостьЭлементовПоКорректировкеРеализации2_5()
	...
	Элементы.РасхожденияВернуть.Видимость = Объект.КорректировкаРеализации2_5 И ЗначениеЗаполнено(Объект.Договор);
