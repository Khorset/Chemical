...
Процедура ПодсказкаПоОсобенностиУчетаНоменклатуры(ТекстПодсказки, ОсобенностьУчета) Экспорт
	...
	ИначеЕсли ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ЛегкаяПромышленность2026 Тогда
		ТекстПодсказки = НСтр("ru = 'Осуществляется обмен с ИС МП информацией по обороту товаров легкой промышленности и одежды с 2026 г.'");
...
Процедура ЗначенияРеквизитовСтрогоЗаполняемыеПоОсобенностямУчета(ЗначенияЗаполнения) Экспорт
	...
	ЗначенияЗаполнения.Вставить(Перечисления.ОсобенностиУчетаНоменклатуры.ЛегкаяПромышленность2026,             ЗначенияРеквизитов);
	...
	ЗначенияЗаполнения.Вставить(Перечисления.ОсобенностиУчетаНоменклатуры.ТоварыИзНатуральногоМеха,             ЗначенияРеквизитов);
