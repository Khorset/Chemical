...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка, ДополнительныеПараметры = Неопределено) Экспорт
	...
	//++ РозничнаяПродажаТабачнойПродукцииТолькоПоМРЦ
	РозничныеПродажиЛокализация.ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка, ДополнительныеПараметры);
	//-- РозничнаяПродажаТабачнойПродукцииТолькоПоМРЦ
	...
	Если Форма.ИмяФормы = "Документ.ЧекККМ.Форма.ФормаДокументаРМК" Тогда
		...
		Если Не Форма.ОткрыватьФормуСПодключеннымОборудованием = Истина Тогда
			РозничныеПродажиЛокализация.ПроверитьКорректностьЦеныПродажиИМРЦТабачнойПродукции(
				Форма, "АкцизныеМарки", Истина, Ложь);
		КонецЕсли;
	КонецЕсли;
...
Процедура ПриЧтенииНаСервере(Форма, ТекущийОбъект, ДополнительныеПараметры = Неопределено) Экспорт
	...
	//++ РозничнаяПродажаТабачнойПродукцииТолькоПоМРЦ
	РозничныеПродажиЛокализация.ПриЧтенииНаСервере(Форма, ТекущийОбъект, ДополнительныеПараметры);
	//-- РозничнаяПродажаТабачнойПродукцииТолькоПоМРЦ
...
Процедура ПриИзмененииЭлемента(Форма, Элемент, ДополнительныеПараметры) Экспорт
	...
	РозничныеПродажиЛокализация.ПриИзмененииЭлемента(Форма, Элемент, ДополнительныеПараметры);
