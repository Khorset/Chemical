...
Функция ТекстЗапросаДинамическогоСпискаКонтрагенты()
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~2	
	ТекстЗапроса = СхемыЗапросов.ДобавитьПолеВыборкиВЗапрос(ТекстЗапроса, "СправочникКонтрагенты._Закрыт", "КонтрагентЗакрыт");
	ТекстЗапроса = СхемыЗапросов.ДобавитьПолеВыборкиВЗапрос(ТекстЗапроса, "ВЫРАЗИТЬ(СправочникКонтрагенты.ДополнительнаяИнформация КАК СТРОКА(200))", "ДополнительнаяИнформация");
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~3	
