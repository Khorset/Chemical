...
Процедура ЗаполнитьСписокВыбораАдресовПеревозчика(ЭлементыФормы, ДокОбъект)
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~2
	АдресаДоставки = Справочники.AMS_АдресаДоставки.ПолучитьАдресаДоставки(ПеревозчикПартнер);
	ДополнитьСписокВыбораИзТаблицыАдресов(СписокВыбора, АдресаДоставки, НСтр("ru = 'Адрес доставки'"));
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~3
...
Процедура ЗаполнитьСпискиВыбораАдресовПолучателяОтправителя(ЭлементыФормы, ДокОбъект) Экспорт
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~5
	АдресаДоставки = Справочники.AMS_АдресаДоставки.ПолучитьАдресаДоставки(ПолучательОтправитель);
	ДополнитьСписокВыбораИзТаблицыАдресов(СписокВыбора, АдресаДоставки, НСтр("ru = 'Адрес доставки'"));
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~6
