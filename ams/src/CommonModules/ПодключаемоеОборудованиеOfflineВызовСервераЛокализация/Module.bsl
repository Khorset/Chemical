...
Процедура ЗаполнитьСтруктуруПрайсЛистаИзДанныхКВыгрузке(СтруктураПрайсЛиста, ТоварыКВыгрузке) Экспорт
	...
	Пока ВыборкаПоНоменклатуре.Следующий() Цикл
		...
		Если ВыборкаПоНоменклатуре.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ПродукцияИзНатуральногоМеха
			Или ВыборкаПоНоменклатуре.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ТоварыИзНатуральногоМеха Тогда
		...
		ИначеЕсли ВыборкаПоНоменклатуре.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ЛегкаяПромышленность 
			Или ВыборкаПоНоменклатуре.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ЛегкаяПромышленность2025
			Или ВыборкаПоНоменклатуре.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ЛегкаяПромышленность2026 Тогда
...
Функция ТекстЗапросаДанныеТоваровДляВыгрузки(Знач Параметры, Знач ИспользоватьСерииНоменклатуры)
	...
	|				ИЛИ КодыТоваровПодключаемогоОборудованияOffline.ОсобенностьУчета В (
