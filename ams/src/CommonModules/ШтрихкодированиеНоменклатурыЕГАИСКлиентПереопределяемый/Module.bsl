...
Процедура ПодготовитьДанныеДляОбработкиТаблицыТоваровПолученнойИзТСД(
	...
	//++ НЕ ГОСИС
	ПараметрыЗаполненияНоменклатурыЕГАИС = ИнтеграцияЕГАИСКлиентСервер.ПараметрыЗаполненияТабличнойЧасти();
	ПараметрыЗаполненияНоменклатурыЕГАИС.ЗаполнитьАлкогольнуюПродукцию = Истина;
	
	СтруктураДействийСДобавленнымиСтроками = Новый Структура;
	СтруктураДействийСДобавленнымиСтроками.Вставить("ЗаполнитьАлкогольнуюПродукцию", ПараметрыЗаполненияНоменклатурыЕГАИС);
	...
	СтруктураДействий.ДействияСНеизвестнымиШтрихкодами        = "РегистрацияОбязательна";
	//-- НЕ ГОСИС
	Возврат;
...
Процедура ОткрытьФормуРегистрацииШтрихкодовНоменклатуры(Форма, ДанныеШтрихкодов) Экспорт
	...
	ПараметрыОткрытияФормы.Вставить("ДействияСНеизвестнымиШтрихкодами", "РегистрацияОбязательна");
