...
// Проверить наличие скидок оплат бонусными баллами в документе
// 
// Параметры:
//  ДокументОбъект - ДокументОбъект.РеализацияТоваровУслуг - Документ объект
Процедура ПроверитьНаличиеСкидокОплатБонуснымиБалламиПоТабачнойПродукции(ДокументОбъект) Экспорт
	...
	РозничныеПродажиЛокализация.ПроверитьНаличиеСкидокОплатБонуснымиБаллами(
		ДокументОбъект,
		ИмяТаблицыТоваров,
