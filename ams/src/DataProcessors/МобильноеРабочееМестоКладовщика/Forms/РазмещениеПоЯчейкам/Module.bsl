...
Процедура ОбновитьФормуНаСервере(Результат)
	...
	Иначе
		...
		КоэффициентУпаковкиРазместить = Справочники.УпаковкиЕдиницыИзмерения.КоэффициентУпаковки(ТоварыРазместить[НомерСтроки].Упаковка, ТоварыРазместить[НомерСтроки].Номенклатура);
