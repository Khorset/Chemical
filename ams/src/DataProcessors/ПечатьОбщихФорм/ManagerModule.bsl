...
Функция СформироватьПечатнуюФормуТОРГ12(СтруктураТипов, ОбъектыПечати, ПараметрыПечати) Экспорт
	...
	Для Каждого СтруктураОбъектов Из СтруктураТипов Цикл
		...
		ДанныеДляПечати = амсПолучитьДанныеДляПечатнойФормыТОРГ12(СтруктураОбъектов.Значение);
		//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~3
...
Процедура ЗаполнитьРеквизитыШапкиТОРГ12(ДанныеПечати, Макет, ТабличныйДокумент)
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~5
	амсУстановитьПараметрыПечати(ДанныеПечати, ОбластьМакета, "ТОРГ12");
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~6
...
Функция ЗаполнитьРеквизитыПодвалаТОРГ12(ДанныеПечати, ИтоговыеСуммы, Макет, КоэффициентПересчетаВТонны)
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8
	амсУстановитьПараметрыПечати(ДанныеПечати, ОбластьМакета, "ТОРГ12", Истина);
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~9
...
Процедура ЗаполнитьТабличныйДокументТОРГ12(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, ПараметрыПечати)
	...
	Иначе
		...
		//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~11
		Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.ПечатьОбщихФорм.ТОРГ12");
		//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~12
...
//	ОбъектыПечати - СписокЗначений - список объектов печати
//
Процедура ЗаполнитьТабличныйДокументМ15(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати) Экспорт
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~13
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~14
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.AMS_ПередачаВПереработку.ПФ_MXL_М15_ru");
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~15
...
Процедура ЗаполнитьРеквизитыШапкиСчетФактура(ДанныеПечати, ДанныеОснований, СведенияОПоставщике, ДанныеКонтрагентов, ТабличныйДокумент, ОпцииПечатиСчетаФактуры, ДанныеПоставщиков)
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~19
	амсУстановитьПараметрыПечати(ДанныеПечати, ОбластьМакета, "СчетФактура");
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~20
...
Процедура ЗаполнитьРеквизитыПодвалаСчетФактура(ОбластьПодвала, ДанныеПечати, СведенияОбОрганизации)
	...
	Если СведенияОбОрганизации.ЮрФизЛицо = Перечисления.ЮрФизЛицо.ЮрЛицо Тогда
		...
		//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~21
		СтруктураПараметров.ФИОГлавногоБухгалтера = ДанныеПечати.Организация._ГлавныйБухгалтер;
		
		ОтветственноеЛицо = мср.ПолучитьОтветственноеЛицо(ДанныеПечати.Организация);
		Если Не ОтветственноеЛицо = Неопределено Тогда
			СтруктураПараметров.ФИОРуководителя = ОтветственноеЛицо;
			СтруктураПараметров.ФИОГлавногоБухгалтера = ОтветственноеЛицо;
		КонецЕсли;
		//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~22
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Иначе
			...
			Если Не СтрокаБезРасхождений Тогда
				...
				//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~24
				Если УчетНДСРФ.СтранаЯвляетсяЧленомТаможенногоСоюза(ДанныеПечати.Контрагент.СтранаРегистрации, ДанныеПечати.Дата) Тогда 
					ОбластьМакета.Параметры.КодТНВЭД = СтрокаТовары.КодТНВЭД;
				КонецЕсли;
				//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~25
...
Процедура ЗаполнитьРеквизитыШапкиУПД(ДанныеПечати, СведенияОПоставщике, ДанныеКонтрагентов, ОбластьМакета, ДанныеПоставщиков, ОпцииПечати)
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~29
	амсУстановитьПараметрыПечати(ДанныеПечати, ОбластьМакета, "УПД");
КонецПроцедуры
...
Процедура ЗаполнитьРеквизитыПодвалаУПД2_5(ОбластьПодвала, ОбластьПодвалаНакладной, ДанныеПечати, СведенияОбОрганизации, ДанныеКонтрагентов)
	...
	Если ОтветственноеЛицо = Неопределено Тогда
		ОбластьПодвала.Параметры.ФИОГлавногоБухгалтера = ДанныеПечати.Организация._ГлавныйБухгалтер;
	Иначе
		ОбластьПодвала.Параметры.ФИОРуководителя = ОтветственноеЛицо;
		ОбластьПодвала.Параметры.ФИОГлавногоБухгалтера = ОтветственноеЛицо;
	КонецЕсли;
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~32
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~33
	ОбластьПодвалаНакладной.Параметры.ДолжностьКладовщика = ДанныеПечати.Организация._ДолжностьКладовщика; 
	ОбластьПодвалаНакладной.Параметры.ФИОКладовщика       = ДанныеПечати.Организация._Кладовщик; 

	ОтветственноеЛицо = мср.ПолучитьОтветственноеЛицо(ДанныеПечати.Организация);
	Если Не ОтветственноеЛицо = Неопределено Тогда
		ОбластьПодвалаНакладной.Параметры.ДолжностьОтветственного = "Помощник бухгалтера";
		ОбластьПодвалаНакладной.Параметры.ФИООтветственного       = ОтветственноеЛицо;
	КонецЕсли;
КонецПроцедуры
...
Процедура ЗаполнитьТабличныйДокументУПД(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати) Экспорт
	...
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~35
	МакетУПД_981  = УправлениеПечатью.МакетПечатнойФормы("Обработка.ПечатьОбщихФорм.УПД981");
	МакетУПД_534  = УправлениеПечатью.МакетПечатнойФормы("Обработка.ПечатьОбщихФорм.УПД534");
	МакетУПД_1096 = УправлениеПечатью.МакетПечатнойФормы("Обработка.ПечатьОбщихФорм.УПД1096");
	МакетУПД_2026_2_5 = УправлениеПечатью.МакетПечатнойФормы("Обработка.ПечатьОбщихФорм.УПД2026_25");
	//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~36
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Пока СтрокаТовары.Следующий() Цикл
			...
			//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~39
			ДополнитьСтруктуруПараметровУПД(СтруктураПараметров, СтрокаТовары);
			//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~40
...
Процедура ЗаполнитьТабличныйДокументУКД(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати) Экспорт
	...
	Пока ДанныеПечати.Следующий() Цикл
		//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~44
		ВыборкаПоДокументам = AMS_Сервер.ПолучитьВыборкаПоДокументамУКД(ДанныеПечати.Ссылка).Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
		//!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~45
...
Процедура ЗаполнитьРеквизитыПодвалаУКД2_5(ОбластьПодвала, ОбластьПодвалаНакладной, ДанныеПечати, ДанныеОснований, СведенияОбОрганизации, СведенияОКонтрагенте, ОпцииПечати)
	...
	ОтветственноеЛицо = мср.ПолучитьОтветственноеЛицо(ДанныеПечати.Организация);
	Если Не ОтветственноеЛицо = Неопределено Тогда
		ОбластьПодвалаНакладной.Параметры.ФИОРуководителяНакладная = ОтветственноеЛицо;
		ОбластьПодвалаНакладной.Параметры.ДолжностьОтветственного  = "Помощник бухгалтера";
		ОбластьПодвалаНакладной.Параметры.ФИООтветственного        = ОтветственноеЛицо;
	КонецЕсли;
КонецПроцедуры
...
Функция амсСформироватьПечатнуюФормуТОРГ12(СтруктураТипов, ОбъектыПечати, ПараметрыПечати) Экспорт
	УстановитьПривилегированныйРежим(Истина);
...
Функция амсПолучитьДанныеДляПечатнойФормыТОРГ12(МассивОбъектов) Экспорт
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗРЕШЕННЫЕ
	...
	|	Орг._ГлавныйБухгалтер КАК ГлавныйБухгалтер,
	|	Орг._Кладовщик КАК Кладовщик,
	|	Орг._ДолжностьКладовщика КАК ДолжностьКладовщика,
	|	Орг.Префикс КАК Префикс,
	|	док.Основание КАК Основание,
	|	док.ОснованиеДата КАК ОснованиеДата,
	|	док.ОснованиеНомер КАК ОснованиеНомер,
	|	ВЫБОР
	...
	|	ВЫБОР
	|		КОГДА док.Грузоотправитель = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
	...
	|	док.ДоверенностьНомер КАК ДоверенностьНомер,
	|	док.ДоверенностьДата КАК ДоверенностьДата,
	|	док.ДоверенностьВыдана КАК ДоверенностьВыдана,
	|	док.ДоверенностьЛицо КАК ДоверенностьЛицо,
	...
	|	тов.НоменклатураНабора КАК НоменклатураНабора,
	|	тов.ХарактеристикаНабора КАК ХарактеристикаНабора,
	|	ЛОЖЬ КАК ЭтоКомплектующие,
	|	ЛОЖЬ КАК ЭтоНабор,
	|	ЛОЖЬ КАК ПолныйНабор,
	|	тов.Номенклатура КАК Номенклатура,
	|	Ном.НаименованиеПолное КАК НоменклатураНаименование,
	|	Ном.Наименование КАК НоменклатураНаименованиеКраткое,
	|	Ном.Артикул КАК НоменклатураКод,
	|	Упа.Владелец.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	|	Упа.Владелец.ЕдиницаИзмерения.Наименование КАК ЕдиницаИзмеренияНаименование,
	|	Упа.Владелец.ЕдиницаИзмерения.Код КАК ЕдиницаИзмеренияКод,
	|	тов.Характеристика КАК Характеристика,
	|	тов.Характеристика.НаименованиеПолное КАК ХарактеристикаНаименование,
	|	тов.Упаковка КАК Упаковка,
	|	ВЫБОР
	|		КОГДА Упа.Числитель / ВЫБОР
	|				КОГДА Упа.Знаменатель = 0
	|					ТОГДА 1
	|				ИНАЧЕ Упа.Знаменатель
	|			КОНЕЦ = 1
	|			ТОГДА """"
	|		ИНАЧЕ Упа.Наименование
	|	КОНЕЦ КАК УпаковкаНаименование,
	|	Упа.ЕдиницаИзмерения.Наименование КАК ВидУпаковки,
	...
	|	тов.КоличествоУпаковок КАК КоличествоМест,
	|	Упа.Числитель / ВЫБОР
	|		КОГДА Упа.Знаменатель = 0
	|			ТОГДА 1
	|		ИНАЧЕ Упа.Знаменатель
	|	КОНЕЦ КАК КоличествоВОдномМесте,
	|	(тов.СуммаСНДС - тов.СуммаНДС) / ВЫБОР
	|		КОГДА тов.Количество = 0
	|			ТОГДА 1
	|		ИНАЧЕ тов.Количество
	|	КОНЕЦ КАК Цена,
	|	тов.СуммаСНДС - тов.СуммаНДС КАК СуммаБезНДС,
	|	тов.СуммаНДС КАК СуммаНДС,
	|	тов.СуммаСНДС КАК СуммаСНДС,
	|	Ном.ВесЧислитель * тов.Количество / ВЫБОР
	|		КОГДА Ном.ВесЗнаменатель = 0
	|			ТОГДА 1
	|		ИНАЧЕ Ном.ВесЗнаменатель
	|	КОНЕЦ КАК МассаНетто,
	|	Упа.Вес * тов.КоличествоУпаковок КАК МассаБрутто,
	|	тов.НомерСтроки КАК НомерСтроки,
	|	тов.НомерСтроки КАК НомерСтрокиНаборы,
	|	ЛОЖЬ КАК ЭтоВозвратнаяТара,
	|	ВЫБОР
	|		КОГДА док.Партнер.Родитель = ЗНАЧЕНИЕ(Справочник.Партнеры.ПустаяСсылка)
	|			ТОГДА док.Партнер
	|		ИНАЧЕ док.Партнер.Родитель
	|	КОНЕЦ КАК Партнер,
	|	док.Партнер._ШтрихКодУпаковки КАК ШтрихКодУпаковки,
	|	Ном._Упаковка КАК УпаковкаОсновная
	|ПОМЕСТИТЬ вт
	|ИЗ
	...
	|			И (НЕ Ном.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара))
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.УпаковкиЕдиницыИзмерения КАК Упа
	|		ПО тов.Упаковка = Упа.Ссылка
	...
	|	НомКлиентов.Артикул КАК Артикул
	|ПОМЕСТИТЬ арт
	|ИЗ
	|	вт КАК вт
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений._НоменклатураКлиентов КАК НомКлиентов
	|		ПО вт.Партнер = НомКлиентов.Партнер
	|			И вт.Номенклатура = НомКлиентов.Номенклатура
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|ИЗ
	|	вт КАК вт
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ШтрихкодыНоменклатуры КАК Штр
	|		ПО вт.Номенклатура = Штр.Номенклатура
	|			И (Штр.Упаковка = ЗНАЧЕНИЕ(Справочник.УпаковкиЕдиницыИзмерения.ПустаяСсылка)
	|				ИЛИ Штр.Упаковка.Числитель = 1)
	|			И (НЕ вт.ШтрихКодУпаковки)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|ИЗ
	|	вт КАК вт
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений._ШтрихкодыКанистр КАК ШтрКанистр
	|		ПО вт.Номенклатура = ШтрКанистр.Номенклатура
	|			И (НЕ вт.ШтрихКодУпаковки)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ШтрихкодыНоменклатуры КАК Штр
	|		ПО вт.Номенклатура = Штр.Номенклатура
	|			И вт.УпаковкаОсновная = Штр.Упаковка
	|			И (вт.ШтрихКодУпаковки)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	вт.Ссылка КАК Ссылка,
	|	вт.ВариантПредставленияНабораВПечатныхФормах КАК ВариантПредставленияНабораВПечатныхФормах,
	|	вт.ВариантРасчетаЦеныНабора КАК ВариантРасчетаЦеныНабора,
	|	вт.НоменклатураНабора КАК НоменклатураНабора,
	|	вт.ХарактеристикаНабора КАК ХарактеристикаНабора,
	|	вт.ЭтоКомплектующие КАК ЭтоКомплектующие,
	|	вт.ЭтоНабор КАК ЭтоНабор,
	|	вт.ПолныйНабор КАК ПолныйНабор,
	|	вт.Номенклатура КАК Номенклатура,
	|	вт.НоменклатураНаименование КАК НоменклатураНаименование,
	|	вт.НоменклатураНаименованиеКраткое КАК НоменклатураНаименованиеКраткое,
	|	вт.НоменклатураКод КАК НоменклатураКод,
	|	вт.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	|	вт.ЕдиницаИзмеренияНаименование КАК ЕдиницаИзмеренияНаименование,
	|	вт.ЕдиницаИзмеренияКод КАК ЕдиницаИзмеренияКод,
	|	вт.Характеристика КАК Характеристика,
	|	вт.ХарактеристикаНаименование КАК ХарактеристикаНаименование,
	|	вт.Упаковка КАК Упаковка,
	|	вт.УпаковкаНаименование КАК УпаковкаНаименование,
	|	вт.ВидУпаковки КАК ВидУпаковки,
	|	вт.СтавкаНДС КАК СтавкаНДС,
	|	вт.НомерГТД КАК НомерГТД,
	|	вт.СтранаПроисхождения КАК СтранаПроисхождения,
	|	вт.Количество КАК Количество,
	|	вт.КоличествоМест КАК КоличествоМест,
	|	вт.КоличествоВОдномМесте КАК КоличествоВОдномМесте,
	|	вт.Цена КАК Цена,
	|	вт.СуммаБезНДС КАК СуммаБезНДС,
	|	вт.СуммаНДС КАК СуммаНДС,
	|	вт.СуммаСНДС КАК СуммаСНДС,
	|	вт.МассаНетто КАК МассаНетто,
	|	вт.МассаБрутто КАК МассаБрутто,
	|	вт.НомерСтроки КАК НомерСтроки,
	|	вт.НомерСтрокиНаборы КАК НомерСтрокиНаборы,
	|	вт.ЭтоВозвратнаяТара КАК ЭтоВозвратнаяТара,
	|	арт.Артикул КАК Артикул,
	|	штр.Штрихкод КАК Штрихкод
	|ИЗ
	|	вт КАК вт
	|		ЛЕВОЕ СОЕДИНЕНИЕ арт КАК арт
	|		ПО вт.Номенклатура = арт.Номенклатура
...
// Печать СПЕЦИФИКАЦИИ ТОВАРОВ

Функция амсСформироватьПечатнуюФормуСпецификации(МассивОбъектов, ОбъектыПечати, ПараметрыПечати, КомплектыПечати = Неопределено) Экспорт
	УстановитьПривилегированныйРежим(Истина);
	...
	ТабличныйДокумент.КлючПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_Спецификация";
	
	ДанныеДляПечати = амсПолучитьДанныеДляПечатнойФормыСпецификации(МассивОбъектов);
	
	амсЗаполнитьТабличныйДокументСпецификации(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати);
	
	Возврат ТабличныйДокумент;
КонецФункции

Функция амсПолучитьДанныеДляПечатнойФормыСпецификации(МассивОбъектов)
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	док.Ссылка КАК Ссылка,
	|	док.Номер КАК Номер,
	|	ВЫБОР
	|		КОГДА док.AMS_ДатаСчета = ДАТАВРЕМЯ(1, 1, 1, 0, 0, 0)
	|			ТОГДА док.Дата
	|		ИНАЧЕ док.AMS_ДатаСчета
	|	КОНЕЦ КАК Дата,
	|	док.Контрагент КАК Контрагент,
	|	док.Контрагент.КПП КАК КПППокупателя,
	|	ВЫБОР
	|		КОГДА док.Грузополучатель = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
	|			ТОГДА док.Контрагент
	|		ИНАЧЕ док.Грузополучатель
	...
	|	Орг._Руководитель КАК Руководитель,
	|	док.Валюта КАК Валюта,
	|	Вал.НаименованиеПолное КАК ВалютаНаименованиеПолное,
	|	Вал.Код КАК ВалютаКод
	|ИЗ
	|	Документ.РеализацияТоваровУслуг КАК док
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Организации КАК Орг
	|		ПО док.Организация = Орг.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Валюты КАК Вал
	|		ПО док.Валюта = Вал.Ссылка
	|ГДЕ
	|	док.Ссылка В(&МассивОбъектов)
	|;
	|
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК Ном
	|		ПО тов.Номенклатура = Ном.Ссылка
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.УпаковкиЕдиницыИзмерения КАК Упа
	|		ПО тов.Упаковка = Упа.Ссылка
	...
	СтруктураДанныхДляПечати  = Новый Структура("РезультатПоШапке, РезультатПоТабличнойЧасти",МассивРезультатов[0],МассивРезультатов[1]);
	
	Возврат СтруктураДанныхДляПечати;
КонецФункции

Процедура амсЗаполнитьРеквизитыШапкиСпецификации(ДанныеПечати, СведенияОПоставщике, СведенияОПокупателе, Макет, ТабличныйДокумент)
	ДатаСведений = ДанныеПечати.Дата;	
	...
	ПараметрыШапки.Вставить("Номер", НомерСчетаФактурыНаПечать(ДанныеПечати.Номер, 0));
	ПараметрыШапки.Вставить("Дата", Формат(ДанныеПечати.Дата, "ДЛФ=ДД"));
	...
	// Выводим данные грузоотправителя.
	ТекстГрузоотправителя = "";
	Если ДанныеПечати.Грузоотправитель = Неопределено Тогда
		ТекстГрузоотправителя = "--";
	...
	// Выводим данные грузополучателя и покупателя.
	ТекстГрузополучателя = "--";
	Если Не ДанныеПечати.Грузополучатель = Неопределено Тогда
	...
	ПараметрыШапки.Вставить("СпособПоставки", "Способ доставки: Самовывоз автомобильным транспортом.");
	
	ПараметрыШапки.Вставить("Валюта", НСтр("ru='Валюта: наименование - Российский рубль, код - 643.'"));
	
	ОбластьМакета.Параметры.Заполнить(ПараметрыШапки);
	
	амсУстановитьПараметрыПечати(ДанныеПечати,ОбластьМакета,"Спецификация");
	
	ТабличныйДокумент.Вывести(ОбластьМакета);
	
КонецПроцедуры

Процедура амсЗаполнитьТабличныйДокументСпецификации(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати)
	ВалютаРегламентированногоУчета = Константы.ВалютаРегламентированногоУчета.Получить();
	
	ДанныеПечати      	= ДанныеДляПечати.РезультатПоШапке.Выбрать();
	ВыборкаПоДокументам = ДанныеДляПечати.РезультатПоТабличнойЧасти.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
	
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.ПечатьОбщихФорм.Спецификация");
	ОбластьЗаголовокТаблицы = Макет.ПолучитьОбласть("ЗаголовокТаблицы");
	ОбластьСтрока           = Макет.ПолучитьОбласть("Строка");
	ОбластьИтого            = Макет.ПолучитьОбласть("Итого");
	ОбластьВсего            = Макет.ПолучитьОбласть("Всего");
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		//@skip-check query-in-loop
		амсЗаполнитьРеквизитыШапкиСпецификации(ДанныеПечати, СведенияОбОрганизации, СведенияОКонтрагенте, Макет, ТабличныйДокумент);
		...
		ИтогоПоДокументу = Новый Структура;
		ИтогоПоДокументу.Вставить("Количество"    ,ВыборкаПоДокументам.Количество);
		ИтогоПоДокументу.Вставить("КоличествоМест",ВыборкаПоДокументам.КоличествоМест);
		ИтогоПоДокументу.Вставить("СуммаСНДС"     ,ВыборкаПоДокументам.СуммаСНДС);
		ИтогоПоДокументу.Вставить("МассаНетто"    ,ВыборкаПоДокументам.МассаНетто);
		ИтогоПоДокументу.Вставить("МассаБрутто"   ,ВыборкаПоДокументам.МассаБрутто);
			
		ВыборкаПоКодамТНВЭД = ВыборкаПоДокументам.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
		КоличествоСтрок = ВыборкаПоКодамТНВЭД.Количество();
		НовыйКодТНВЭД = Ложь;
		НомерСтроки = 0;
		Пока ВыборкаПоКодамТНВЭД.Следующий() Цикл
			НовыйКодТНВЭД = Истина;
			
			ОбластьИтого.Параметры.Заполнить(ВыборкаПоКодамТНВЭД);
			Если НЕ ЗначениеЗаполнено(ОбластьИтого.Параметры.КодТНВЭД) Тогда 
				ОбластьИтого.Параметры.КодТНВЭД = "Не установлен.";
			КонецЕсли;
			ТабличныйДокумент.Вывести(ОбластьИтого);
		
			СтрокаТовары = ВыборкаПоКодамТНВЭД.Выбрать();
			КоличествоСтрок = СтрокаТовары.Количество();
			Пока СтрокаТовары.Следующий() Цикл
				НомерСтроки = НомерСтроки + 1;
				
				амсЗаполнитьРеквизитыСтрокиТовара(СтрокаТовары, ОбластьСтрока, НомерСтроки, ,Истина);
				
				МассивВыводимыхОбластей.Очистить();
				МассивВыводимыхОбластей.Добавить(ОбластьСтрока);
				Если НовыйКодТНВЭД Тогда
					МассивВыводимыхОбластей.Добавить(ОбластьИтого);
					НовыйКодТНВЭД = Ложь;
				КонецЕсли;
				Если НомерСтроки = КоличествоСтрок Тогда
				...
				Если НомерСтроки <> 1 И НЕ ТабличныйДокумент.ПроверитьВывод(МассивВыводимыхОбластей) Тогда
					...
					ОбластьНумерацияЛистов.Параметры.Номер = НомерСчетаФактурыНаПечать(ДанныеПечати.Номер,0);
					ОбластьНумерацияЛистов.Параметры.Дата = Формат(ДанныеПечати.Дата, "ДЛФ=ДД; ДП=--");
					ОбластьНумерацияЛистов.Параметры.НомерСтраницы = НомерСтраницы;
		...
		// Выводим итоги по документу в целом
		ОбластьВсего.Параметры.Заполнить(ИтогоПоДокументу);
		ТабличныйДокумент.Вывести(ОбластьВсего);
		...
		КоличествоСтраниц = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Документ составлен на %1 %2'"),	НомерСтраницы,
			ОбщегоНазначенияУТКлиентСервер.ФормаМножественногоЧисла(
				НСтр("ru = 'листе'"), НСтр("ru = 'листах'"), НСтр("ru = 'листах'"), НомерСтраницы)) + ".";
		СтруктураПараметров.Вставить("КоличествоСтраниц", КоличествоСтраниц);
		
		КолСтр = "Спецификация товаров содержит: " + ЧислоПрописью(НомерСтроки,,",,,,,,,,0") + "порядковых номеров записей.";
		СтруктураПараметров.Вставить("КоличествоПорядковыхНомеровЗаписейПрописью", КолСтр);
		
		ВсегоМест = "Всего мест: " + ЧислоПрописью(ИтогоПоДокументу.КоличествоМест,,",,,,,,,,0") + ".";
		СтруктураПараметров.Вставить("ВсегоМестПрописью", ВсегоМест);
		
		Масса = "Масса груза (нетто): " + ИтогоПоДокументу.МассаНетто + " кг, Масса груза (брутто): " + ИтогоПоДокументу.МассаБрутто + "кг.";
		СтруктураПараметров.Вставить("Масса", Масса);
		
		СуммаПрописью = РаботаСКурсамиВалют.СформироватьСуммуПрописью(ИтогоПоДокументу.СуммаСНДС , ВалютаРегламентированногоУчета) + ".";
		СтруктураПараметров.Вставить("СуммаПрописью", СуммаПрописью);
		
		СтруктураПараметров.Вставить("ДолжностьРуководителя", ДанныеПечати.ДолжностьРуководителя +":");
		
		ОтветственноеЛицо = мср.ПолучитьОтветственноеЛицо(ДанныеПечати.Организация);
		Если ОтветственноеЛицо = Неопределено Тогда
			СтруктураПараметров.Вставить("Руководитель", ДанныеПечати.Руководитель);
		Иначе	
			СтруктураПараметров.Вставить("Руководитель", ОтветственноеЛицо);
		КонецЕсли;
				
		СтруктураПараметров.Вставить("ДатаДокумента", Формат(ДанныеПечати.Дата, "ДФ=""дд ММММ гггг """"года"""""""));
...
Процедура амсЗаполнитьРеквизитыСтрокиТовара(СтрокаТовары, ОбластьМакета, НомерСтроки, ВыводитьКодНоменклатуры = Истина, ВыводитьКодТНВД = Ложь)
...
// Печать АКТ О РАСХОЖДЕНИЯХ ТОВАРОВ

Функция амсСформироватьПечатнуюФормуАктОРасхождениях(МассивОбъектов, ОбъектыПечати, ПараметрыПечати, КомплектыПечати = Неопределено) Экспорт
	УстановитьПривилегированныйРежим(Истина);
	...
	ТабличныйДокумент.КлючПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_АктОРасхождениях";
	
	ДанныеДляПечати = амсПолучитьДанныеДляПечатнойФормыАктОРасхождениях(МассивОбъектов);
	
	амсЗаполнитьТабличныйДокументАктОРасхождениях(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати);
	
	Возврат ТабличныйДокумент;
КонецФункции

Функция амсПолучитьДанныеДляПечатнойФормыАктОРасхождениях(МассивОбъектов)
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	док.Ссылка КАК Ссылка,
	...
	|	Ном.ЕдиницаИзмерения.Представление КАК Ед,
	|	тов.Количество КАК Количество,
	|	тов.Сумма / ВЫБОР
	|		КОГДА тов.Количество = 0
	|			ТОГДА 1
	...
	|	Ном.КоэффициентЕдиницыДляОтчетов КАК КоличествоВУпаковке
	|ИЗ
	|	Документ.РеализацияТоваровУслуг КАК док
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.РеализацияТоваровУслуг.Товары КАК тов
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК Ном
	|			ПО тов.Номенклатура = Ном.Ссылка
...
Процедура амсЗаполнитьТабличныйДокументАктОРасхождениях(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати)
	ДанныеПечати      	= ДанныеДляПечати.РезультатПоШапке.Выбрать();
	ВыборкаПоДокументам = ДанныеДляПечати.РезультатПоТабличнойЧасти.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
	
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.ПечатьОбщихФорм.АктОРасхождениях");
	
	ОбластьЗаголовокТаблицы = Макет.ПолучитьОбласть("Заголовок");
	ОбластьСтрока           = Макет.ПолучитьОбласть("Строка");
	ОбластьНумерацияЛистов  = Макет.ПолучитьОбласть("НумерацияЛистов");
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		//@skip-check query-in-loop
		амсЗаполнитьРеквизитыШапкиАктОРасхождениях(ДанныеПечати, СведенияОбОрганизации, СведенияОКонтрагенте, Макет, ТабличныйДокумент);
		...
		СтрокаТовары = ВыборкаПоДокументам.Выбрать();
		КоличествоСтрок = СтрокаТовары.Количество() + 3;
		НомерСтроки = 0;
		Пока СтрокаТовары.Следующий() Цикл
			НомерСтроки = НомерСтроки + 1;
		...
		Для Сч = 1 По 3 Цикл
			...
			ОбластьПусто.Параметры.НомерСтроки = НомерСтроки;
			
			МассивВыводимыхОбластей.Очистить();
			МассивВыводимыхОбластей.Добавить(ОбластьПусто);
...
Процедура амсЗаполнитьРеквизитыШапкиАктОРасхождениях(ДанныеПечати, СведенияОПоставщике, СведенияОПокупателе, Макет, ТабличныйДокумент)
	ОбластьМакета = Макет.ПолучитьОбласть("Шапка");
	...
	ПараметрыШапки.Вставить("АдресПоставщика", ФормированиеПечатныхФорм.ОписаниеОрганизации(СведенияОПоставщике, "ЮридическийАдрес") + ".");
	ПараметрыШапки.Вставить("ИННПоставщика", ФормированиеПечатныхФорм.ОписаниеОрганизации(СведенияОПоставщике, "ИНН", Ложь) + ?(Не ПустаяСтрока(ДанныеПечати.КПППоставщика), "/" + ДанныеПечати.КПППоставщика, "") + ".");
	
	// Выводим данные покупателя.
	ПараметрыШапки.Вставить("ПредставлениеПокупателя", ФормированиеПечатныхФорм.ОписаниеОрганизации(СведенияОПокупателе, "ПолноеНаименование", Ложь) + ".");
	ПараметрыШапки.Вставить("АдресПокупателя", ФормированиеПечатныхФорм.ОписаниеОрганизации(СведенияОПокупателе, "ЮридическийАдрес", Ложь) + ".");
	ПараметрыШапки.Вставить("ИННПокупателя", ФормированиеПечатныхФорм.ОписаниеОрганизации(СведенияОПокупателе, "ИНН,", Ложь) + ?(Не ПустаяСтрока(ДанныеПечати.КПППокупателя), "/" + ДанныеПечати.КПППокупателя, "") + ".");
	
	ОбластьМакета.Параметры.Заполнить(ПараметрыШапки);
	
	амсУстановитьПараметрыПечати(ДанныеПечати,ОбластьМакета,"АктОРасхождениях");
	
	ТабличныйДокумент.Вывести(ОбластьМакета);
КонецПроцедуры

// Прочие процедуры Печати

Функция амсУстановитьПараметрыПечати(ДанныеПечати, ОбластьМакета, ТипДокумента, ЭтоПодвал = ЛОЖЬ) Экспорт
	Парам = ОбластьМакета.Параметры;
	
	Фирма = ДанныеПечати.Организация;
	
	//@skip-check bsl-legacy-check-string-literal
	ФирмаНаименование = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Фирма, "НаименованиеСокращенное");
	
	Если ТипЗнч(ДанныеПечати.Ссылка) = Тип("ДокументСсылка.СчетФактураВыданный") 
		ИЛИ ТипЗнч(ДанныеПечати.Ссылка) = Тип("ДокументСсылка.КорректировкаРеализации") Тогда
		Док = ДанныеПечати.Ссылка.ДокументОснование;
		
		Если ТипЗнч(Док) = Тип("ДокументСсылка.СчетФактураВыданный") ИЛИ ТипЗнч(Док) = Тип("ДокументСсылка.КорректировкаРеализации") Тогда
			Док = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Док, "ДокументОснование");
			
		ИначеЕсли ТипЗнч(Док) = Тип("ДокументСсылка.ВозвратТоваровПоставщику") Тогда 
			Возврат Ложь;
		КонецЕсли;
		
	ИначеЕсли ТипЗнч(ДанныеПечати.Ссылка) = Тип("ДокументСсылка.СчетФактураВыданныйАванс") Тогда
		Возврат Ложь;
		
	Иначе
		Док = ДанныеПечати.Ссылка;
	КонецЕсли;
	
	Партнер = Док.Партнер;
	
	Если ТипЗнч(Док) = Тип("ДокументСсылка.АктВыполненныхРабот") Тогда
		СтрДок = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Док, "Контрагент,Организация");
		
		Запрос = Новый Запрос;
		Запрос.УстановитьПараметр("Партнер", Партнер);
		Запрос.УстановитьПараметр("Контрагент", СтрДок.Контрагент);
		Запрос.Текст = 
		"ВЫБРАТЬ
		|	т.Ссылка КАК Правила,
		|	т.Организация
		|ИЗ
		...
		ИначеЕсли Табл.Количество() = 1 Тогда 
			Правила = Табл[0].Правила;
			
		Иначе
			Стр = Табл.Найти(СтрДок.Организация,"Организация");
	...
	Иначе
		...
		Если ОбщегоНазначенияУТКлиентСервер.ЕстьРеквизитОбъекта(Док,"AMS_ПравилоПродажи") Тогда 
			Правила = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Док,"AMS_ПравилоПродажи");
		КонецЕсли;
	КонецЕсли;
	...
	Если ТипДокумента = "ТОРГ12" Тогда
		Если ЭтоПодвал Тогда
			ОтветственноеЛицо = мср.ПолучитьОтветственноеЛицо(ДанныеПечати.Организация);
			Если Не ОтветственноеЛицо = Неопределено Тогда
				Парам.ФИОРуководителя = ОтветственноеЛицо;
				Парам.ФИОГлавБухгалтера = ОтветственноеЛицо;
				
				Если ДанныеПечати.Организация = AMS_ВызовСервера.ОрганизацияТрейд() Тогда
					Парам.ФИОКладовщика = ОтветственноеЛицо;
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
	...
	ИначеЕсли ТипДокумента = "СчетФактура" Тогда
		Если НЕ ДанныеПечати.КорректировочныйСчетФактура Тогда
			Парам.ПредставлениеГрузоотправителя = ФирмаНаименование + ", 141150, Московская обл, Лосино-Петровский г, Первомайская ул, дом № 1, строение 27";
		КонецЕсли;
		
	ИначеЕсли ТипДокумента = "УПД" Тогда
		Если ТипЗнч(Док) = Тип("ДокументСсылка.ПередачаТоваровМеждуОрганизациями") Тогда
			Если ЭтоПодвал Тогда
				Если Фирма = AMS_ВызовСервера.ОрганизацияТД() Тогда
					Парам.ДолжностьКладовщика = "Зам. начальника склада";
				Иначе
					Парам.ДолжностьКладовщика = "Начальник склада"; 
				КонецЕсли;
				
				Парам.Основание = "Договор № 04/08-20 от 03.08.2020 г.";
				Парам.ФИОКладовщика = Фирма._Кладовщик; 
				
				ОтветственноеЛицо = мср.ПолучитьОтветственноеЛицо(ДанныеПечати.Организация);
				
				Если ОтветственноеЛицо = Неопределено Тогда
					Парам.ФИОГлавногоБухгалтера = Фирма._ГлавныйБухгалтер;
				Иначе
					Парам.ФИОРуководителяОрганизации = ОтветственноеЛицо;
					Парам.ФИОГлавногоБухгалтера = ОтветственноеЛицо;
					Парам.ДолжностьРуководителя = "Помощник бухгалтера";
					Парам.ФИОРуководителя = ОтветственноеЛицо;
				КонецЕсли;
				
				ОтветственноеЛицо = мср.ПолучитьОтветственноеЛицо(ДанныеПечати.Контрагент);
				
				Парам.ДолжностьТоварПолучил = "Помощник бухгалтера";
				Парам.ФИОТоварПолучил = ОтветственноеЛицо;
		...
		Иначе	
			Если Не ЭтоПодвал Тогда
				Если Парам.ДокументыОбОтгрузке = Неопределено Тогда 
					Парам.ДокументыОбОтгрузке = "Универсальный передаточный документ № " + Парам.Номер + " от " + Парам.Дата;
				КонецЕсли;
				
				Если ДанныеПечати.Организация.ИНН = "7733272907" Тогда
					Парам.ИННПоставщика = "7733272907/505045001";
				КонецЕсли;
				
				Если ЗначениеЗаполнено(Правила) Тогда
					ГрузополучательНаименование = ДанныеПечати.Грузополучатель.НаименованиеПолное;
					Если СтрНайти(ГрузополучательНаименование, "Офисмаг") > 0 Тогда
						Парам.ПредставлениеГрузополучателя = ГрузополучательНаименование + ", " + ДанныеПечати.АдресДоставки;
					КонецЕсли;
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
			
	ИначеЕсли ТипДокумента = "ТТН-Подвал" Тогда
		ОтветственноеЛицо = мср.ПолучитьОтветственноеЛицо(ДанныеПечати.Организация);
		Если Не ОтветственноеЛицо = Неопределено Тогда
			Парам.ФИОРуководителя = ОтветственноеЛицо;
			Парам.ФИОГлавБухгалтера = ОтветственноеЛицо;
		КонецЕсли;
		Парам.ФИОГрузПринял = амсПолучитьВодителя(Док);;
		
	ИначеЕсли ТипДокумента = "ТТН-СведенияОГрузе" Тогда
		Парам.ФИОГрузПринял = амсПолучитьВодителя(Док);;
	КонецЕсли;
...
Процедура ДополнитьСтруктуруПараметровУПД(СтруктураПараметров, СтрокаТовары)
	Партнер      = СтрокаТовары.Ссылка.Партнер;
	...
	|	т.КоэффициентЕдиницыДляОтчетов КАК КоличествоВОдномМесте,
	|	&Количество / т.КоэффициентЕдиницыДляОтчетов КАК КоличествоМест,
	|	т._Упаковка.Вес * &Количество / т.КоэффициентЕдиницыДляОтчетов КАК МассаБрутто,
	...
	|ИЗ
	|	тов КАК тов
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений._НоменклатураКлиентов КАК Ном
	|		ПО тов.Номенклатура = Ном.Номенклатура
	|			И (Ном.Партнер = &Партнер)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|		ПО тов.Номенклатура = Штр.Номенклатура
	|			И (Штр.Упаковка.Числитель = 1)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|ИЗ
	|	тов КАК тов
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений._ШтрихкодыКанистр КАК Штр
	|		ПО тов.Номенклатура = Штр.Номенклатура
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	тов.Номенклатура КАК Номенклатура,
	|	тов.КоличествоВОдномМесте КАК КоличествоВОдномМесте,
	|	тов.КоличествоМест КАК КоличествоМест,
	|	тов.МассаБрутто КАК МассаБрутто,
	|	арт.Артикул КАК Артикул,
	|	ЕСТЬNULL(штр1.Штрихкод, штр2.Штрихкод) КАК Штрихкод,
	|	тов.КодТНВЭД КАК КодТНВЭД
	|ИЗ
	|	тов КАК тов
	|		ЛЕВОЕ СОЕДИНЕНИЕ арт КАК арт
	|		ПО тов.Номенклатура = арт.Номенклатура
	|		ЛЕВОЕ СОЕДИНЕНИЕ штр1 КАК штр1
	|		ПО тов.Номенклатура = штр1.Номенклатура
	|		ЛЕВОЕ СОЕДИНЕНИЕ штр2 КАК штр2
	|		ПО тов.Номенклатура = штр2.Номенклатура";

	Рез = Запрос.Выполнить();
	Выб = Рез.Выбрать();
	Выб.Следующий();

	СтруктураПараметров.Вставить("Артикул", Выб.Артикул);
	СтруктураПараметров.Вставить("Штрихкод", Выб.Штрихкод);
	СтруктураПараметров.Вставить("КоличествоВОдномМесте", Выб.КоличествоВОдномМесте);
	СтруктураПараметров.Вставить("КоличествоМест", Выб.КоличествоМест);
	СтруктураПараметров.Вставить("МассаБрутто", Выб.МассаБрутто);
	СтруктураПараметров.Вставить("СтранаПроисхожденияКод", "643");
	СтруктураПараметров.Вставить("СтранаПроисхождения", "РОССИЯ");
КонецПроцедуры

Функция амсПолучитьАртикулКлиента(Номенклатура,Партнер)
	Родитель = Партнер.Родитель;
	
	Запрос = Новый Запрос;
	Запрос.УстановитьПараметр("Номенклатура", Номенклатура);
	Запрос.УстановитьПараметр("Партнер"     , ?(ЗначениеЗаполнено(Родитель),Родитель,Партнер));
...
Функция амсПолучитьНомерПоставщика(ИсходныйТекст, ИмяНомера)
	Строка = ВРег(ИсходныйТекст);
	Имя = ВРег(ИмяНомера);
	
	Позиция = СтрНайти(Строка, Имя);
	
	Если Позиция > 0 Тогда
	    
	    Стр = СокрЛП(Прав(Строка, СтрДлина(Строка) - Позиция - СтрДлина(Имя) + 1));
	...
	Возврат ИмяНомера + " " + Номер;
КонецФункции

Функция амсПолучитьВодителя(Распоряжение)
	Запрос = Новый Запрос;
	Запрос.УстановитьПараметр("Распоряжение", Распоряжение);
	
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	Рейсы.Водитель.Наименование КАК Водитель
	|ИЗ
