...
Процедура ТаблицаДокументовОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Для каждого СтрокаДокумента Из МассивДокументовПодбора Цикл
		...
		Если ЕстьДокументвТЧ(СтрокаДокумента) Тогда
			ДатаМобайл_ОбщийМодульКлиент.СообщитьПользователю("Документ: " + СтрокаДокумента + " уже был добавлен в список. ");
		Иначе	
			...
			ДатаМобайл_ОбщийМодульКлиент.СообщитьПользователю("Документ: " + СтрокаДокумента + " добавлен в список. ");
		КонецЕсли;
