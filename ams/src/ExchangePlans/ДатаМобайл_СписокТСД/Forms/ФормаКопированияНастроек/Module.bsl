...
Процедура СкопироватьНастройкиНаСервере()
	...
	Если Счетчик = 0 Тогда
		ДатаМобайл_ОбщийМодуль.СообщитьПользователю("Выберите ТСД, в которые нужно скопировать настройки!");
	Иначе	
		ДатаМобайл_ОбщийМодуль.СообщитьПользователю("Копирование настроек в выбранные ТСД завершена!");
	КонецЕсли;
